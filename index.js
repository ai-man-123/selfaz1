...
LINK = https://chat.whatsapp.com/BfgtNWNdijIDizp3B1Iyp2 ( group MASTAH Mark)
LINK = https://chat.whatsapp.com/BfgtNWNdijIDizp3B1Iyp2 ( group MASTAH Mark)
LINK = https://chat.whatsapp.com/BfgtNWNdijIDizp3B1Iyp2 ( group MASTAH Mark)
LINK = https://chat.whatsapp.com/BfgtNWNdijIDizp3B1Iyp2 ( group MASTAH Mark)
LINK = https://chat.whatsapp.com/BfgtNWNdijIDizp3B1Iyp2 ( group MASTAH Mark)
...
╚═══❏ *BOTZ - SELF* ❏══❍`
    ...
    case 'image':
 	...
 	case 'tiktok':
		...
		tik.ssstik(`${args[0]}`)
    		...
    		.then(async (a) => {
    		me = `*Title* : ${text}\n*Link* : ${a.data}`
		syaa.sendMessage(from,{url:`${videonowm}`},video,{mimetype:'video/mp4',quoted:mek,caption:me})
		})
		})
    ...
    case 'tiktokaudio':
		...
		syaa.sendMessage(from,{url:`${music}`},audio,{mimetype:'audio/mp4',filename : `${text}`,quoted:mek})
		})
     		.catch(e => console.log(e))
     		break
    case 'brainly':
